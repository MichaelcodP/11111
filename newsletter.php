...
<head>
	...
	<script src="js/subscribe_scripts.js"></script>
</head>
<body>
	<div class="container">
 <div class="row">
...
<h2 class="text-center">Subscribe for Latest Updates </h2>
    ...
    <br>
    <center><button name="sub_process" class="sub_btn btn btn-primary" id="subscribeButton">Subscribe </button> <img src="images/loading.gif" height="auto" width="50" id="subloader"></center>
    </form>
    </div>
    </div>
</div>
